...
def bidirectional_a_star(graph, source, dest, pi_s=None, pi_t=None):
    ...
    while forward_pq or reverse_pq:
        ...
        if cur_reverse != -1:
            # If the node was processed by the forward search, terminate
